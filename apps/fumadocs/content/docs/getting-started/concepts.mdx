...
graph LR
    ...
    subgraph DeployNodes["Swarm Compute Cluster"]
        DeployServer1["Manager Node (OpenResty Edge + Caddy + Swarm)"]
...
1. **Deploy Server**: Runs Docker Swarm workloads, the OpenResty public edge, Caddy application proxy, overlay networking, and health metrics collection.
