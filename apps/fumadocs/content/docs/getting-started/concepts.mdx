...
graph LR
    ...
    subgraph DeployNodes["Swarm Compute Cluster"]
        DeployServer1["Manager Node (Caddy + Swarm)"]
...
1. **Deploy Server**: Runs Docker Swarm workloads, the Caddy application proxy, overlay networking, and health metrics collection.
