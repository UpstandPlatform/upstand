...
func TestAuthorizeTypedDockerRequestRequiresServerAndNarrowOperations(t *testing.T) {
	tests := []struct {
		...
		{
			name:   "typed monitoring provisioning",
			caller: "server",
			method: http.MethodPost,
			path:   "/upstand/v1/server/monitoring",
			body:   `{"operation":"ensure","image":"ghcr.io/upstandplatform/upstand-monitoring@sha256:eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee","token":"monitoring-token","cpu_threshold":90,"memory_threshold":90,"network_name":"upstand-docker-control","callback_port":3000}`,
			allow:  true,
		},
		{
			name:   "typed monitoring provisioning is not available to schedules",
			caller: "schedules",
			method: http.MethodPost,
			path:   "/upstand/v1/server/monitoring",
			body:   `{"operation":"ensure","image":"ghcr.io/upstandplatform/upstand-monitoring@sha256:eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee","token":"monitoring-token","cpu_threshold":90,"memory_threshold":90,"network_name":"upstand-docker-control","callback_port":3000}`,
		...
		{
			name:   "typed monitoring rejects mutable images",
			caller: "server",
			method: http.MethodPost,
			path:   "/upstand/v1/server/monitoring",
			body:   `{"operation":"ensure","image":"ghcr.io/upstandplatform/upstand-monitoring:latest","token":"monitoring-token","cpu_threshold":90,"memory_threshold":90,"network_name":"upstand-docker-control","callback_port":3000}`,
			allow:  false,
		},
		{
