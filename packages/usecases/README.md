...
- `CreateResourceUseCase` / `DeployApplicationUseCase`: Application compilation, BuildKit execution, Swarm service rolling update, and Caddy application-proxy reconciliation.
