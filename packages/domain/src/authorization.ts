...
export const API_KEY_ROUTE_CAPABILITIES = {
  ...
  "server.setupProgress": "server:view",
  ...
  "deployment.getLogs": "deployment:view",
  ...
  "server.migrateResource": "server:update",
  "server.getWorkloadMigration": "server:view",
  "server.getResourceWorkloadMigration": "server:view",
  "server.cancelWorkloadMigration": "server:update",
  "server.rollbackWorkloadMigration": "server:update",
  "server.confirmWorkloadMigration": "server:update",
