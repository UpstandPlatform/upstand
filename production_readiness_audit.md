...
Date: 2026-08-28
Revision: follow-up infrastructure hardening branch `feat/service-shape-allowlist-v2` (post-PR #350, commit `74084dfc`, PR #354)
...
bounded before any subprocess or Docker transport is started. This reduces
parser, argument, and resource-exhaustion risk while the credential-safe typed
secret streaming contract remains open.
