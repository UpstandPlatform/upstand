...
require_workflow_text 'STACK_NAME: upstand-rel-acpt'
...
require_workflow_text 'for attempt in {1..12}; do'
...
require_workflow_text 'acceptance_command_timeout_seconds=180'
require_workflow_text 'run_acceptance_command()'
require_workflow_text 'acceptance_service_diagnostics()'
require_workflow_text 'acceptance phase failed:'
require_workflow_text 'if docker service inspect "$service_name"'
...
require_workflow_text '--env HEALTH_LOAD_REQUEST_TIMEOUT_SECONDS=2'
